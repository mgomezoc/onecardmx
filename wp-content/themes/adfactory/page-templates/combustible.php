...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
				...
				<div class="row h-600 d-flex align-items-start pt-6 justify-content-center">
					...
					<div class="col-lg-6 text-center">
						...
						<div class="text-center pt-5 pb-4">
							<a href="https://onecard.mx/comercios-afiliados-combustible/" class="btn-1 mayusculas ">Comercios afiliados</a>
						</div>
					</div>
		...
		<a href="https://onecard.mx/saldo/">
			<img src="https://onecard.mx/wp-content/uploads/baner-onecard.png" alt="" class="w-100">
		</a>
